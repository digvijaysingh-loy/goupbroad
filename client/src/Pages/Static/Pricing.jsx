  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className={fromAuth && userData ? 'pt-6 sm:pt-8' : 'pt-16 sm:pt-24'}>
        ...
        <section className="py-12 sm:py-20 bg-gradient-to-br from-[#145044]/5 to-[#145044]/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge className="bg-[#145044] text-white px-4 py-2 text-xs sm:text-sm font-medium mb-5">
              Choose Your Plan
            </Badge>
            <h1 className="text-2xl sm:text-5xl md:text-5xl font-bold text-gray-900 leading-tight">
              ...
              <span className="ml-2 mt-2 text-[#145044]">Study Abroad Journey</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto mt-6 leading-relaxed px-2 text-justify sm:text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              ...
              <Card className="border-2 border-gray-200 hover:border-[#145044]/30 transition-all duration-300">
                <CardHeader className="text-center pb-6 pt-8">
                  ...
                  <div className="mt-5">
                    <span className="text-3xl sm:text-4xl font-bold text-[#145044]">₹{basicPlan.price.toLocaleString('en-IN')}</span>
                ...
                <CardContent className="space-y-5 px-6 pb-8">
                  ...
                  <Button
                    className="w-full bg-[#145044] hover:bg-[#145044]/90 text-white py-6 text-base sm:text-lg rounded-xl"
                    size="lg"
              ...
              <Card className="border-4 border-[#145044] relative transform scale-100 sm:scale-105 shadow-2xl z-10">
                <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
                  <Badge className="bg-[#145044] text-white px-5 py-2 text-sm font-bold shadow-lg">
                ...
                <CardHeader className="text-center pb-6 pt-10">
                  ...
                  <div className="mt-5">
                    <span className="text-3xl sm:text-4xl font-bold text-[#145044]">₹{proPlan.price.toLocaleString('en-IN')}</span>
                    <span className="text-gray-500 text-sm block mt-1">/ one-time</span>
                  </div>
                </CardHeader>
                <CardContent className="space-y-5 px-6 pb-8">
                  ...
                  <Button
                    className="w-full bg-[#145044] hover:bg-[#145044]/90 text-white py-6 text-base sm:text-lg rounded-xl shadow-lg"
                    size="lg"
              ...
              <Card className="border-2 border-gray-200 hover:border-[#145044]/30 transition-all duration-300">
                <CardHeader className="text-center pb-6 pt-8">
                  ...
                  <div className="mt-5">
                    <span className="text-3xl sm:text-4xl font-bold text-[#145044]">₹{premierPlan.price.toLocaleString('en-IN')}</span>
                    <span className="text-gray-500 text-sm block mt-1">/ one-time</span>
                  </div>
                </CardHeader>
                <CardContent className="space-y-5 px-6 pb-8">
            ...
            <div className="px-4">
              <Card className="max-w-2xl mx-auto border-2 border-orange-300 bg-orange-50/80 shadow-lg">
                <CardContent className="p-6 sm:p-8 text-justify">
                  ...
                  <div className="text-2xl sm:text-3xl font-bold mb-5 text-[#145044]">₹7,000 / university</div>
        ...
        <section className="py-16 sm:py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-10">Why Choose UpBroad?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="space-y-4">
                  <div className="w-16 h-16 mx-auto rounded-full bg-[#145044] flex items-center justify-center">
